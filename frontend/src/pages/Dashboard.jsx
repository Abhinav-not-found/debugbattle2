...
const Dashboard = () => {
  ...
  const handleAddVariantDraft = () => {
    ...
    const varSku =
      ...
      "VAR-" + Math.random().toString(36).substr(2, 6).toUpperCase()
  ...
  const addOrderItemField = () => {
    setNewOrder({
      ...
      items: [
        ...newOrder.items,
        { productId: "", variantSku: "", quantity: 1 },
      ],
    })
  }
  ...
  const handleOrderSubmit = async (e) => {
    ...
    if (invalid) {
      showToast(
        "Please fill out all product and variant selections, and verify quantities are positive.",
        "warning",
      )
      return
    }
  ...
  return (
    <div className='flex h-screen w-screen overflow-hidden bg-black text-zinc-100 font-sans'>
                    ...
                    <Card className='bg-zinc-950 border-zinc-900 hover:border-zinc-800 transition-all duration-300 relative overflow-hidden'>
                      ...
                      <CardContent>
                        ...
                        <p className='text-[10px] text-zinc-450 mt-1'>
                          {lowStockCount} low stock • {outOfStockCount} out of
                          stock
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    <div className='bg-zinc-950 border border-zinc-800 p-4 rounded flex items-start gap-3'>
                      ...
                      <div>
                        ...
                        <p className='text-xs text-zinc-400 mt-0.5'>
                          ...
                          items low in stock. Please visit the Inventory tab to
                          replenish items.
                        </p>
                      </div>
                    </div>
                    ...
                    <Card className='lg:col-span-2 bg-zinc-950 border-zinc-900'>
                      <CardHeader>
                        ...
                        <CardDescription className='text-zinc-500'>
                          Latest shop activities log
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        {orders.length === 0 ? (
                          <p className='text-sm text-zinc-550 py-6 text-center'>
                  ...
                  <div className='flex justify-between items-center bg-zinc-950 p-6 rounded border border-zinc-900'>
                    <div>
                      ...
                      <p className='text-sm text-zinc-550'>
                        List, add, and inspect details of all products in
                        inventory.
                      </p>
                    </div>
                    <Button
                      ...
                      {products.length === 0 ? (
                        <div className='text-center py-12'>
                          ...
                          <p className='text-xs text-zinc-500 max-w-sm mx-auto mt-1'>
                            Get started by creating your first product item in
                            the database catalog.
                          </p>
                          <Button
                            onClick={() => setShowProductModal(true)}
                            className='mt-4 bg-white text-black hover:bg-zinc-250'
                          >
                            Create Product
                          </Button>
                        </div>
                                        ...
                                        <div className='flex flex-wrap gap-1 pl-12'>
                                          {product.variants.map((v) => (
                                            <Badge
                                              key={v._id || v.sku}
                                              variant='secondary'
                                              className='text-[9px] px-1 py-0 bg-zinc-900 border-zinc-800 text-zinc-400 uppercase font-mono'
                                            >
                                              {v.size || ""}
                                              {v.size && v.color ? "/" : ""}
                                              {v.color || ""} ({v.stock})
                ...
                <div className='space-y-6'>
                  <div className='flex justify-between items-center bg-zinc-950 p-6 rounded border border-zinc-900'>
                    <div>
                      ...
                      <p className='text-sm text-zinc-550'>
                        Record customer billing details and monitor order
                        progress.
                      </p>
                    </div>
                    <Button
                      onClick={() => {
                        if (products.length === 0) {
                          alert(
                            "Please create at least one product before placing an order.",
                          )
                          return
                        }
                    ...
                    <CardContent className='p-6'>
                      {orders.length === 0 ? (
                        <div className='text-center py-12'>
                          ...
                          <p className='text-xs text-zinc-500 max-w-sm mx-auto mt-1'>
                            Draft a custom order by clicking the create order
                            button above.
                          </p>
                          <Button
                            onClick={() => {
                ...
                <div className='space-y-6'>
                  <div className='flex justify-between items-center bg-zinc-950 p-6 rounded border border-zinc-900'>
                    <div>
                      ...
                      <p className='text-sm text-zinc-550'>
                        Configure warehoused products and handle stock levels
                        manually.
                      </p>
                    </div>
                    <Button
                    ...
                    <CardContent className='p-6'>
                      {inventory.length === 0 ? (
                        <div className='text-center py-12'>
                          ...
                          <p className='text-xs text-zinc-550 max-w-sm mx-auto mt-1'>
                            Products currently do not have inventory
                            associations.
                          </p>
                        </div>
                      ) : (
                  ...
                  <Card className='bg-zinc-950 border-zinc-900'>
                    <CardHeader>
                      ...
                      <CardDescription className='text-zinc-450'>
                        Configure localized settings for the administration
                        panel.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      ...
                      >
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                          ...
                          <div className='space-y-2'>
                            <Label htmlFor='taxRate' className='text-zinc-300'>
                              Default Tax Rate (%)
                            </Label>
                            <Input
                              id='taxRate'
                  ...
                  <Card className='bg-zinc-950 border-zinc-900'>
                    <CardHeader className='flex flex-row items-center justify-between pb-2'>
                      <div>
                        ...
                        <CardDescription className='text-zinc-500'>
                          Administrate system metadata preferences.
                        </CardDescription>
                      </div>
                      {!isEditingProfile ? (
                        <Button
                        ...
                        <div className='flex gap-2'>
                          <Button
                            ...
                            className='border-zinc-850 text-zinc-300'
                          >
                            Cancel
                          </Button>
                          <Button
                      ...
                      {isEditingProfile ? (
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-4'>
                          <div className='space-y-2'>
                            ...
                            <Select
                              ...
                              onValueChange={(val) =>
                                setProfileData({ ...profileData, skills: val })
                              }
                            >
                              <SelectTrigger className='bg-black border-zinc-800 text-white'>
                          ...
                          <div className='space-y-2'>
                            ...
                            <Select
                              ...
                              onValueChange={(val) =>
                                setProfileData({ ...profileData, post: val })
                              }
                            >
                              <SelectTrigger className='bg-black border-zinc-800 text-white'>
                          ...
                          <div className='space-y-2'>
                            ...
                            <Select
                              ...
                              onValueChange={(val) =>
                                setProfileData({ ...profileData, roles: val })
                              }
                            >
                              <SelectTrigger className='bg-black border-zinc-800 text-white'>
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-4'>
                          <div className='p-4 rounded bg-zinc-900/40 border border-zinc-800 flex items-start gap-3'>
                            ...
                            <div>
                              <h3 className='text-sm font-semibold text-zinc-250'>
                                Primary Skill
                              </h3>
                              <p className='text-zinc-400 mt-1'>
                                {user.profile?.skills || "Not specified"}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className='p-4 rounded bg-zinc-900/40 border border-zinc-800 flex items-start gap-3'>
                            ...
                            <div>
                              ...
                              <p className='text-zinc-400 mt-1'>
                                {user.profile?.post || "Not specified"}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className='p-4 rounded bg-zinc-900/40 border border-zinc-800 flex items-start gap-3'>
                            ...
                            <div>
                              ...
                              <p className='text-zinc-400 mt-1'>
                                {user.profile?.roles || "Not specified"}
                              </p>
                            </div>
                          </div>
          ...
          <form onSubmit={handleProductSubmit} className='space-y-4'>
            <div className='grid grid-cols-2 gap-4'>
              <div className='col-span-2 space-y-1'>
                <Label htmlFor='prod-name' className='text-zinc-300 text-xs'>
                  Product Name *
                </Label>
                <Input
                  id='prod-name'
              ...
              <div className='space-y-1'>
                <Label htmlFor='prod-price' className='text-zinc-300 text-xs'>
                ...
                {productVariants.length > 0 && (
                  <p className='text-[10px] text-zinc-500 mt-0.5'>
                    Price is defined by variants below.
                  </p>
                )}
              </div>
              <div className='space-y-1'>
              ...
              <div className='space-y-1'>
                <Label htmlFor='prod-sku' className='text-zinc-400 text-xs'>
                  Base SKU (Auto-generated if empty)
                </Label>
                <Input
                  id='prod-sku'
              ...
              <div className='space-y-1'>
                <Label htmlFor='prod-stock' className='text-zinc-400 text-xs'>
                ...
                {productVariants.length > 0 && (
                  <p className='text-[10px] text-zinc-500 mt-0.5'>
                    Stock is defined by variants below.
                  </p>
                )}
              </div>
              <div className='col-span-2 space-y-1'>
                <Label htmlFor='prod-image' className='text-zinc-400 text-xs'>
                  Product Image Photo
                </Label>
                <Input
                  id='prod-image'
              ...
              {productVariants.length > 0 && (
                <div className='space-y-1.5 max-h-[120px] overflow-y-auto'>
                  {productVariants.map((v) => (
                    <div
                      key={v.sku}
                      className='flex justify-between items-center bg-black/50 border border-zinc-850/80 px-3 py-1.5 rounded text-xs font-mono'
                    >
                      <span>
                        Size:{" "}
                        ...
                        | SKU:{" "}
                        <strong className='text-zinc-300'>{v.sku}</strong>
                      </span>
                      <div className='flex items-center gap-4'>
                        <span>
                          {storeSettings.currency}
            ...
            <div className='space-y-1'>
              <Label htmlFor='prod-desc' className='text-zinc-400 text-xs'>
                Product Description
              </Label>
              <textarea
                id='prod-desc'
            ...
            <div className='flex justify-end gap-3 pt-4 border-t border-zinc-900'>
              <Button
                ...
                className='border-zinc-800 text-zinc-450'
              >
                Cancel
              </Button>
              <Button
      ...
      <Dialog open={showOrderModal} onOpenChange={setShowOrderModal}>
        <DialogContent className='sm:max-w-2xl border-zinc-900 bg-zinc-950 text-slate-100 max-h-[90vh] overflow-y-auto'>
          ...
          <form onSubmit={handleOrderSubmit} className='space-y-4'>
            <div className='grid grid-cols-2 gap-4'>
              <div className='space-y-1'>
                <Label htmlFor='ord-cust' className='text-zinc-400 text-xs'>
                  Customer Name *
                </Label>
                <Input
                  id='ord-cust'
              ...
              <div className='space-y-1'>
                <Label htmlFor='ord-status' className='text-zinc-400 text-xs'>
                  Status
                </Label>
                <Select
                  value={newOrder.status}
                  onValueChange={(val) =>
                    setNewOrder({ ...newOrder, status: val })
                  }
                >
                  <SelectTrigger className='bg-black border-zinc-800 text-white'>
                    <SelectValue />
              ...
              <div className='space-y-3'>
                {newOrder.items.map((item, idx) => {
                  ...
                  return (
                    <div
                      key={item}
                      className='flex flex-col gap-3 bg-zinc-900/30 border border-zinc-850 p-4 rounded'
                    >
                      <div className='flex gap-4 items-end'>
                        <div className='flex-1 space-y-1'>
                          ...
                          <Select
                            ...
                            onValueChange={(val) =>
                              handleOrderItemsChange(idx, "productId", val)
                            }
                          >
                      ...
                      {hasVariants && (
                        <div className='space-y-1'>
                          ...
                          <Select
                            ...
                            onValueChange={(val) =>
                              handleOrderItemsChange(idx, "variantSku", val)
                            }
                          >
                            <SelectTrigger className='bg-black border-zinc-800 text-white h-9'>
                            ...
                            <SelectContent className='bg-zinc-950 border-zinc-900 text-slate-200'>
                              {selectedProduct.variants.map((v) => (
                                <SelectItem key={v.sku} value={v.sku}>
                                  ...
                                  {storeSettings.currency}
                                  {v.price.toFixed(2)} - Stock: {v.stock})
                                </SelectItem>
                              ))}
                            </SelectContent>
                          </Select>
            ...
            <div className='flex justify-end gap-3 pt-4 border-t border-zinc-900'>
              <Button
                ...
                className='border-zinc-800 text-zinc-355'
              >
                Cancel
              </Button>
              <Button
        ...
        <DialogContent className='sm:max-w-md border-zinc-900 bg-zinc-950 text-slate-100'>
          ...
          <form onSubmit={handleInventorySubmit} className='p-6 space-y-4'>
            ...
            {newInventory.productId &&
              products.find((p) => p._id === newInventory.productId)?.variants
                ?.length > 0 && (
                <div className='space-y-1'>
                  <Label className='text-zinc-355 text-xs'>
                    Select Variant *
                  </Label>
                  <Select
                    value={newInventory.variantSku}
                    onValueChange={(val) =>
                      setNewInventory({ ...newInventory, variantSku: val })
                    }
                  >
                    <SelectTrigger className='bg-black border-zinc-800 text-white'>
                    ...
                    <SelectContent className='bg-zinc-950 border-zinc-900 text-slate-200'>
                      ...
                      {products
                        .find((p) => p._id === newInventory.productId)
                        .variants.map((v) => (
                          <SelectItem key={v.sku} value={v.sku}>
                            {v.sku} ({v.size || ""}
                            {v.size && v.color ? "/" : ""}
            ...
            <div className='space-y-1'>
              <Label htmlFor='inv-warehouse' className='text-zinc-355 text-xs'>
                Warehouse Location
              </Label>
              <Input
                id='inv-warehouse'
            ...
            <div className='grid grid-cols-2 gap-4'>
              <div className='space-y-1'>
                <Label className='text-zinc-455 text-xs'>
                  Adjustment Method
                </Label>
                <Select
                  value={newInventory.mode}
                  onValueChange={(val) =>
                    setNewInventory({ ...newInventory, mode: val })
                  }
                >
                  <SelectTrigger className='bg-black border-zinc-800 text-white'>
                    <SelectValue />
              ...
              <div className='space-y-1'>
                <Label htmlFor='inv-qty' className='text-zinc-300 text-xs'>
                  Quantity *
                </Label>
                <Input
                  id='inv-qty'
            ...
            <div className='flex justify-end gap-3 pt-4 border-t border-zinc-900'>
              <Button
                ...
                className='border-zinc-800 text-zinc-350'
              >
                Cancel
              </Button>
              <Button
      ...
      <Dialog
        open={showProductViewModal}
        onOpenChange={setShowProductViewModal}
      >
            ...
            <div className='space-y-6 mt-4'>
              <div className='flex gap-6 items-start'>
                ...
                <div className='space-y-1.5 flex-1 min-w-0'>
                  ...
                  <p className='text-xs text-zinc-400 font-mono'>
                    Base SKU: {selectedViewProduct.sku}
                  </p>
                  <p className='text-xs text-zinc-450'>
                    Category: {selectedViewProduct.category}
                  </p>
                  <div className='pt-1.5'>
                    {selectedViewProduct.variants &&
                    selectedViewProduct.variants.length > 0 ? (
                      <Badge
                        variant='secondary'
                        className='bg-zinc-900 border-zinc-800 text-zinc-300 font-mono text-[10px]'
                      >
                      ...
                      <Badge
                        variant={
                          selectedViewProduct.stock > 0
                            ? "success"
                            : "destructive"
                        }
                      >
                        {selectedViewProduct.stock > 0
                          ? `${selectedViewProduct.stock} In Stock`
                          : "Out of Stock"}
                      </Badge>
                    )}
                  </div>
                  ...
                  <div className='border border-zinc-900 rounded overflow-hidden'>
                    <Table>
                      <TableHeader className='bg-zinc-900/30 border-zinc-900'>
                        <TableRow className='hover:bg-transparent border-zinc-900'>
                          <TableHead className='text-zinc-455 h-8 text-[10px] uppercase font-mono'>
                            SKU
                          </TableHead>
                          <TableHead className='text-zinc-455 h-8 text-[10px] uppercase font-mono'>
                            Variant
                      ...
                      <TableBody>
                        {selectedViewProduct.variants.map((v) => (
                          <TableRow
                            key={v.sku}
                            className='border-zinc-900 hover:bg-zinc-900/20'
                          >
                            ...
                            <TableCell className='text-xs text-white font-mono py-2'>
                              {storeSettings.currency}
                              {v.price.toFixed(2)}
                            </TableCell>
              ...
              <div className='flex justify-end pt-4 border-t border-zinc-900'>
                <Button
                  ...
                  className='bg-white text-black hover:bg-zinc-250'
                >
                  Close
                </Button>
              </div>
            ...
            <div className='space-y-6 mt-4'>
              <div className='flex justify-between items-start'>
                <div className='space-y-1'>
                  ...
                  <h3 className='text-lg font-bold text-white font-mono'>
                    {selectedViewOrder.orderNumber}
                  </h3>
                  <p className='text-xs text-zinc-400'>
                    Date:{" "}
                    {new Date(selectedViewOrder.createdAt).toLocaleString()}
                  </p>
                </div>
                    ...
                    variant={
                      selectedViewOrder.status === "Delivered"
                        ...
                        : selectedViewOrder.status === "Cancelled"
                          ? "destructive"
                          : selectedViewOrder.status === "Shipped"
                            ? "info"
                            : "warning"
                    }
                  >
                  ...
                  <Table>
                    <TableHeader className='bg-zinc-900/30 border-zinc-900'>
                      <TableRow className='hover:bg-transparent border-zinc-900'>
                        ...
                        <TableHead className='text-zinc-455 h-8 text-[10px] uppercase font-mono text-center'>
                          Qty
                        </TableHead>
                        <TableHead className='text-zinc-455 h-8 text-[10px] uppercase font-mono text-right'>
                          Unit
                        </TableHead>
                        <TableHead className='text-zinc-455 h-8 text-[10px] uppercase font-mono text-right'>
                          Total
                    ...
                    <TableBody>
                      {selectedViewOrder.items?.map((item, i) => (
                        ...
                        >
                          ...
                          <TableCell className='text-center font-mono text-xs text-zinc-300 py-2'>
                            {item.quantity}x
                          </TableCell>
                          <TableCell className='text-right font-mono text-xs text-zinc-300 py-2'>
                            {storeSettings.currency}
                            {item.price.toFixed(2)}
                          </TableCell>
                          <TableCell className='text-right font-mono text-xs text-white py-2'>
                            {storeSettings.currency}
              ...
              <div className='border-t border-zinc-900 pt-4 flex justify-between items-center'>
                ...
                <strong className='text-lg text-white font-mono'>
                  {storeSettings.currency}
                  {selectedViewOrder.totalAmount.toFixed(2)}
                </strong>
              </div>
